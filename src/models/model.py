...
class lstm_model:
    def __init__(self, n_classes, n_training_timestep, n_inference_timestep, n_activation_units) -> Model:
        self.n_classes = n_classes
        self.n_training_timestep = n_training_timestep
        self.n_inference_timestep = n_inference_timestep
    ...
    def init_training_model(self, ):
        ...
        X = Input(shape=(self.n_training_timestep, self.n_classes)) 
        ...
        for t in range(self.n_training_timestep):
    ...
    def init_inference_model(self, ):
        ...
        for t in range(self.n_inference_timestep):
            # Perform one step of the LSTM_cell
            _, a, c = self.lstm_cell(x)
            # Apply densor to the hidden state output of LSTM_Cell
            out = self.dense_layer(a)
